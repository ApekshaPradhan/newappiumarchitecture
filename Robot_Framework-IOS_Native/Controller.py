...
try:
    auth_token = con.authenticateUser("apeksha.pradhan@sstsinc.com", "jy59zmhzfmg9vfsnp4qyc4sn")
    print "User Authenticated"
except KeyError:
    print "Wrong UserId or Api Key"

file_to_upload = "./TestmunkDemo.Resigned1524753725.ipa"
...
shellScriptFile.write('test1.txt')
